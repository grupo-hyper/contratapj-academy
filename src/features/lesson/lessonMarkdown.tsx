/**
 * lessonMarkdown — render compartilhado do conteúdo em Markdown da aula, na
 * identidade visual das PROPOSTAS comerciais da ContrataPJ (tipografia
 * Outfit/Jakarta + componentes editoriais), sobre o tema dark "Blue Ocean".
 *
 * Extraído de `LessonText.tsx` para ser reaproveitado por `LessonSlides.tsx`
 * (cada slide renderiza uma fatia do mesmo markdown com o MESMO mapa de estilos).
 *
 * Continua SEGURO: sem `dangerouslySetInnerHTML` e sem HTML cru — por isso não
 * sanitizamos `texto_md`.
 *
